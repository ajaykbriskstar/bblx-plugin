<?php
wp_enqueue_script( 'two_bf_countdown_js', TENWEB_SO_URL . '/assets/js/two_bf_countdown.js', array('jquery'), TENWEB_SO_VERSION );
?>
<div class="two_black_friday_countdown_container">
    ...
    <img src="<?php echo TENWEB_SO_URL.'/assets/images/conutdown_dots.png';?>" />
    <div class="two_black_friday_countdown">
...
<p class="two_pro_container_offer_title"><?php _e('30% lifetime discount this Black Friday', 'tenweb-speed-optimizer') ?>
    <img src="<?php echo TENWEB_SO_URL.'/assets/images/offer_underline.png';?>" /></p>
...
<p class="two_pro_option two_pro_bg_flash"><?php echo _e('Enable Cloudflare Enterprise CDN and get', 'tenweb-speed-optimizer'); ?></p>
