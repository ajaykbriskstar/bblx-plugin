...
<div class="two_incompatible_notice">
    <div class="two_incompatible_notice_title">Some plugins are conflicting with <?php echo TWO_SO_ORGANIZATION_NAME; ?> Booster.</div>
    <div class="two_incompatible_notice_desc">
        ...
        Proceeding without deactivation can reduce the efficiency of <?php echo TWO_SO_ORGANIZATION_NAME; ?> Booster and cause technical issues.
    </div>
