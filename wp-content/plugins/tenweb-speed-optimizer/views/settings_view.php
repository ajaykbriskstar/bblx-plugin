...
$disconnect_link = $return_url = get_admin_url() . 'admin.php?page=two_settings_page&disconnect=1';
...
<div class="two_settings_container" dir="ltr" xmlns="http://www.w3.org/1999/html">
    <div class="two_settings wd-box-section">
        <div class="wd-box-title">
            <strong><?php _e(TWO_SO_ORGANIZATION_NAME . ' Booster', 'tenweb-speed-optimizer') ?></strong> <small>v<?php echo TENWEB_SO_VERSION; ?></small><br>
            <strong><?php $mode = get_option( "two_default_mode", OptimizerUtils::MODES["extreme"] ); echo is_array($mode) && !empty($mode['mode']) ? esc_html(ucfirst($mode['mode'])) : 'No'; ?></strong> mode
        </div>
            ...
            <div class="two_settings_tab two_tab_general active">
              <?php if(!\TenWebOptimizer\OptimizerUtils::check_if_hosted_website()){ ?>
                <div class="two_settings_option">
                    <p><b style="font-size: 16px;">Connected to <?php echo TWO_SO_ORGANIZATION_NAME; ?>:
                      <?php
              ...
              <p class="description"><?php _e('Enable test mode to disable optimization for live site. Add ?twbooster=1 to urls to load optimized pages.', 'tenweb-speed-optimizer') ?></p>
                ...
                <div class="two_settings_option">
                    <label for="two_disabled_speed_optimizer_pages"
                           class="wd-label"><?php _e('Pages Where ' . TWO_SO_ORGANIZATION_NAME . ' Booster is Disabled', 'tenweb-speed-optimizer'); ?></label>
                    ...
                    <p class="description">
                      <?php _e('Paths of web pages where ' . TWO_SO_ORGANIZATION_NAME . ' Booster will not work. For making all pages optimizable set two_all_pages_are_optimizable option to true.', 'tenweb-speed-optimizer') ?><br />
