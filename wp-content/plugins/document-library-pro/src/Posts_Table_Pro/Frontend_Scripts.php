...
use Barn2\DLP_Lib\Conditional;
use Barn2\DLP_Lib\CSS_Util;
use Barn2\DLP_Lib\Plugin\Plugin;
...
class Frontend_Scripts implements Service, Registerable, Conditional {
	...
	public function register_styles() {
		...
		wp_register_style( 'posts-table-pro-search-box', Util::get_asset_url( 'css/search-box.min.css' ), [], '1.0.0' );
		...
		$script_params = [
			...
			'language'              => apply_filters(
				...
				[
					...
					'search'       => apply_filters( 'document_library_pro_search_label', __( '', 'document-library-pro' ) ),
