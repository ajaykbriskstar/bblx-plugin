const apiOverview = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYE';
//const apiFlows = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=flows&ticker=XHYE';
const apiDist = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=distribution&ticker=XHYE';
const apiIndex = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYE';
...
async function getBarGraphData() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYE';
...
async function getTableData() {
	apiAll = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYE';
	response = await fetch(apiAll);
	dataAll = await response.json();
	stocks_list_all = dataAll;
	apiTop = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYE';
...
async function getInvestmentGrowth() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=total-return&format=json&ticker=XHYE';
	const response = await fetch(api);
	const data = await response.json();
...
async function getPremDisDataTable() {
	...
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=premium-discount&ticker=XHYE&date_gteq=${lastYear.year}.${lastYear.month}.${lastYear.day}`;
	const response = await fetch(api);
	const data = await response.json();
	var dateOptions = {
		year: 'numeric',
...
async function getPreformanceReturnsTable() {
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYE`;
	//const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYE`;
	const response = await fetch(api);
	const data = await response.json();
...
async function downloadCsv() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYE';
	const response = await fetch(api);
	const data = await response.json();
