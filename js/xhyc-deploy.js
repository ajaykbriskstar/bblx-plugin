const apiOverview = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYC';
//const apiFlows = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=flows&ticker=XHYC';
const apiDist = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=distribution&ticker=XHYC';
const apiIndex = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYC';
...
async function getBarGraphData() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYC';
...
async function getTableData() {
	apiAll = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYC';
	response = await fetch(apiAll);
	dataAll = await response.json();
	stocks_list_all = dataAll;
	apiTop = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYC';
...
async function getInvestmentGrowth() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=total-return&format=json&ticker=XHYC';
	const response = await fetch(api);
	const data = await response.json();
...
async function getPremDisDataTable() {
	 ...
	 * */
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=premium-discount&ticker=XHYC&date_gteq=${lastYear.year}.${lastYear.month}.${lastYear.day}`;
	const response = await fetch(api);
	const data = await response.json();
	var dateOptions = {
		year: 'numeric',
...
async function getPreformanceReturnsTable() {
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYC`;
	//const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYC`;
	const response = await fetch(api);
	const data = await response.json();
	...
	if (asofP != null) {
		...
		jQuery(".asofP").html("-"); // asof_date - null
	}
...
async function downloadCsv() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYC';
	const response = await fetch(api);
	const data = await response.json();
