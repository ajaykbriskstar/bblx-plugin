const apiOverview = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYI';
//const apiFlows = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=flows&ticker=XHYI';
const apiDist = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=distribution&ticker=XHYI';
const apiIndex = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=overview&ticker=XHYI';
...
async function getBarGraphData() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYI';
...
async function getTableData() {
	apiAll = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYI';
	response = await fetch(apiAll);
	dataAll = await response.json();
	stocks_list_all = dataAll;
	apiTop = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=basket-exposures&ticker=XHYI';
...
async function getInvestmentGrowth() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=total-return&format=json&ticker=XHYI';
	const response = await fetch(api);
	const data = await response.json();
...
async function getPremDisDataTable() {
	...
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=premium-discount&ticker=XHYI&date_gteq=${lastYear.year}.${lastYear.month}.${lastYear.day}`;
	const response = await fetch(api);
	const data = await response.json();
	var dateOptions = {
		year: 'numeric',
...
async function getPreformanceReturnsTable() {
	const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYI`;
	//const api = `https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&&function=performance&format=json&ticker=XHYI`;
	const response = await fetch(api);
	const data = await response.json();
...
async function downloadCsv() {
	const api = 'https://data.etflogic.io/test?apikey=a2cabd13-a2f6-3412-a1af-13fa70eabc31&function=holdings&ticker=XHYI';
	const response = await fetch(api);
	const data = await response.json();
